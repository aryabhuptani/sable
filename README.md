...
Current status: private local runtime. Sable is a single repo with domain state under `/home/arya/domains`, a Signal-first bridge, Codex CLI under the hood, and plugin API v1 for local command plugins.
...
For what Sable can do out of the box, see `docs/capabilities.md`. For the current domain architecture, see `/home/arya/domains/orchestrator/projects/domain-architecture/ARCHITECTURE.md`. For upgrades, see `docs/upgrade.md`; for patch notes, see `CHANGELOG.md`.
...
- `knowledge/`: project knowledge attached directly to this repo
- `TASKS.md`: Sable project task file attached directly to this repo
...
- `/home/arya/domains/orchestrator/projects/autotweet/CONFIG.md`
- `/home/arya/domains/orchestrator/projects/autotweet/STYLE_GUIDE.md`
- `/home/arya/domains/orchestrator/projects/autotweet/QUESTION_BANK.md`
- `/home/arya/domains/orchestrator/projects/autotweet/SUGGESTIONS.md`
