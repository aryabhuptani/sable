...
Canonical project root: `/home/arya/projects/sable/`
...
- Codex always runs with working directory `/home/arya`.
...
- Scheduler jobs are persisted in:
...
- Pre-download the model once and keep it on disk. The current default path is `/home/arya/models/faster-whisper-base.en`.
